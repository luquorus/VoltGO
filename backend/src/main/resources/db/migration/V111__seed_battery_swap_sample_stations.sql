-- Sample published battery-swap stations for local/dev testing (EV map, admin battery-swap screen).
-- Safe to re-run: uses fixed UUIDs with ON CONFLICT DO NOTHING / DO UPDATE where needed.

-- Station 1: Hoan Kiem (near seed charging station a000...001)
...
-- Station 3: Cau Giay (near collab test coords)
INSERT INTO station (id, provider_id, created_at)
VALUES (
