-- ============================================================
-- VoltGo Notification System - Database Schema
-- Import this file directly into PostgreSQL
-- DO NOT use with Flyway migration
-- ============================================================

-- 1. Collaborator Notifications
...
CREATE INDEX IF NOT EXISTS idx_push_token_active ON push_token(user_id, is_active) WHERE is_active = TRUE;
...
-- ============================================================
-- Insert seed data for preferences (optional)
-- Each new user will default to all channels enabled
-- ============================================================
-- Preferences are created on-demand in the service layer
