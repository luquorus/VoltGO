...
/// Collaborator Web Theme - Lighter Green
/// 
/// Same as Collaborator Mobile theme for visual consistency
class CollabTheme {
  // Lighter green color palette
  static const Color primaryGreenLight = Color(0xFF66BB6A); // Green 400 - lighter than EV user
  static const Color primaryGreen = Color(0xFF4CAF50); // Green 500
  static const Color primaryGreenDark = Color(0xFF388E3C); // Green 600
  ...
  static const Color sidebarActiveBackground = Color(0xFFE8F5E9);

  /// Light theme with lighter green
  static ThemeData lightTheme = ThemeData(
    useMaterial3: true,
    colorScheme: ColorScheme.light(
      primary: primaryGreenLight, // Lighter green for collab
