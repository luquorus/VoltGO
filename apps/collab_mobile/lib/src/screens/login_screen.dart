          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('VoltGo Collaborator', style: Theme.of(context).textTheme.headlineLarge, textAlign: TextAlign.center),
                const SizedBox(height: 48),
                AppTextField(
                  label: 'Email',
                ...
                const SizedBox(height: 16),
                SecondaryButton(label: 'Register', onPressed: _isLoading ? null : () => context.push('/register')),
              ],
            ),
          ),
        ),
